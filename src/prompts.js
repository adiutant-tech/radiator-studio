...
// --- Opcjonalna referencja zaworu (zdjęcie, {VALVE_REF}) ----------------------
// Wstawiane tylko, gdy user wgrał zdjęcie zaworu; inaczej placeholder znika.

export const VALVE_REF_COMPOSE = `Image [3] is the exact product reference for the valves: copy the valve design from image [3] one to one, its body shape, handwheel, spindle and fittings, changing only its metal finish so it matches the material specified above. Both valves use this exact design.`

export const VALVE_REF_SWAP = `Image [2] is the exact product reference for the valves: keep both valves exactly this design, its body shape, handwheel, spindle and fittings, and change only their metal finish to the material specified above.`
